...
type Param struct {
	...
	Usage []Usage `xml:"descriptions,omitempty" json:"descriptions,omitempty"`
	// A formal or informal expression of a constraint or test
	Constraint []Constraint `xml:"constraints,omitempty" json:"constraints,omitempty"`
	// A reference to a local or remote resource
	Link []validation_root.Link `xml:"links,omitempty" json:"links,omitempty"`
	// A prose statement that provides a recommendation for the use of a parameter.
	Guideline []Guideline `xml:"guidance,omitempty" json:"guidance,omitempty"`
...
type Part struct {
	...
	Link []validation_root.Link `xml:"links,omitempty" json:"links,omitempty"`
	// A partition or component of a control or part
	Part []Part `xml:"parts,omitempty" json:"parts,omitempty"`
}
