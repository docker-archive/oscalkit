+++
title = "Quick Start"
description = "Get up and running with the oscalkit CLI"
weight = 10
draft = false
toc = true
bref = "Install oscalkit and become familiar with the basic functionality it provides"
+++
